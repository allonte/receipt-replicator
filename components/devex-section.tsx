...
const STEPS = [
  {
    ...
    lang: "bash",
    code: [
      { type: "comment", text: "# Install the all&co SDK" },
      { type: "command", text: "npm install @allandco/sdk" },
      { type: "gap" },
      { type: "comment", text: "# Initialize your project" },
      { type: "command", text: "npx allandco init" },
      { type: "gap" },
  ...
  },
  {
    ...
    code: [
      ...
      { type: "keyword", text: "import", after: " { Agent, Tool } ", keyword2: "from", string: " '@allandco/sdk'" },
      { type: "gap" },
  ...
  },
  {
    ...
    code: [
      ...
      { type: "keyword", text: "import", after: " { VectorMemory } ", keyword2: "from", string: " '@allandco/memory'" },
      { type: "gap" },
  ...
  },
  {
    ...
    lang: "bash",
    code: [
      { type: "comment", text: "# Deploy to all&co Cloud" },
      { type: "command", text: "allandco deploy --prod" },
      { type: "gap" },
      ...
      { type: "url", text: "  → https://agents.allandco.dev/researcher" },
    ],
  },
]
    ...
    <section id="devex" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
      <div className="max-w-6xl mx-auto">
        <div className="mb-16">
          ...
          <h2 className="mt-5 text-2xl md:text-3xl font-light tracking-tight leading-[1.05]">
            Built for clients
          </h2>
        </div>
