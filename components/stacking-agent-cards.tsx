...
const AGENTS: Agent[] = [
  {
    label: "CONSTRUCTION",
    title: "Scaffold Management Systems",
    desc: "Track equipment, automate hire/return, optimize inventory in real-time.",
  },
  {
    label: "WEB",
    title: "Custom Websites",
    desc: "AI-powered content, SEO optimization, smart lead capture.",
  },
  {
    label: "CONSTRUCTION",
    title: "Construction Management Systems",
    desc: "Project tracking, resource allocation, automated reporting.",
  },
  {
    label: "HEALTHCARE",
    title: "Hospital Management Systems",
    desc: "Patient records, appointment scheduling, billing automation.",
  },
  {
    label: "EDUCATION",
    title: "School Management Systems",
    desc: "Student records, attendance tracking, report generation, fee management.",
  },
  {
    label: "HR",
    title: "Workers Management System",
    desc: "Payroll, attendance, performance tracking, leave management.",
  },
  {
    label: "RETAIL",
    title: "Billing & Point of Sale",
    desc: "Fast checkout, inventory sync, sales analytics, customer loyalty.",
  },
  {
    label: "RESEARCH",
    title: "Research Job Custom Software",
    desc: "Automated literature review, data extraction, citation management, AI-powered insights and reporting.",
  },
]
