...
const BankReceipt = ({ data }: { data: ReceiptData }) => {
  return (
    <div className="relative font-mono text-sm leading-relaxed max-w-md mx-auto bg-[hsl(var(--receipt-bg))] text-[hsl(var(--receipt-text))] border border-[hsl(var(--receipt-border))] rounded-sm shadow-lg p-6 overflow-hidden">
      {/* Watermark */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-[0.06]">
        <img src={coopLogo} alt="" className="w-64 h-64 object-contain brightness-0" />
      </div>
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-start gap-2 mb-2">
          <img src={coopLogo} alt="Co-op Bank" className="w-10 h-10 object-contain brightness-0" />
