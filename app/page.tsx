...
// ─── Main page ────────────────────────────────────────────────────────────────
export default function AllAndCoPage() {
    ...
    <div className="bg-[#F5F4F0] text-[#111] min-h-screen font-sans antialiased">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 z-30 flex flex-col px-6 md:px-12 pb-12 max-w-3xl">
          ...
          >
            Custom software<br />built from idea<br />to production.
          </h1>
      ...
      <section className="py-20 border-t border-black/[0.06] overflow-hidden select-none">
        <p className="text-center text-xs text-black/40 tracking-[0.25em] uppercase mb-12">
          Trusted by
        </p>
        <div className="relative">
          ...
          <div className="flex w-max" style={{ animation: "marqueeLeft 30s linear infinite" }}>
            {[...Array(3)].map((_, rep) => (
              <div key={rep} className="flex shrink-0">
                {[
                  { src: "/clients/murban-engineering.png", alt: "Murban Engineering" },
                  { src: "/clients/ballan-software.png", alt: "Ballan Software" },
                  { src: "/clients/otno.png", alt: "OTNO" },
                  { src: "/clients/mazika-engineering.png", alt: "Mazika Engineering" },
                ].map((client) => (
                  <div
                    key={`${rep}-${client.alt}`}
                  ...
                  >
                    <img
                      ...
                      alt={client.alt}
                      className="h-12 md:h-14 w-auto object-contain opacity-60 grayscale transition duration-300 hover:opacity-100 hover:grayscale-0 mix-blend-multiply"
                    />
                  </div>
                ))}
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-16">
            <div>
              ...
              <div className="mt-4"><Tag>SOFTWARE TYPES</Tag></div>
              <RevealText className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
                {"Systems tailored to your\nworkflow, ready to ship."}
              </RevealText>
            </div>
            <p className="text-sm text-black/45 leading-relaxed max-w-xs">
              From scoping to deployment, we design, build, and ship custom software that fits your operations exactly.
            </p>
          </div>
      ...
      <section id="workflow" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06] overflow-hidden">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3" onMouseMove={handleMouse}>
            {[
              { n: "01", title: "Define",  desc: "Scope the problem, map workflows, and set requirements. We align on outcomes before writing a single line of code.", delay: 0,   img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/define-5aafAmGBrxZpOqJ3XLHY3n3qzC2I5K.png" },
              { n: "02", title: "Compose", desc: "Design the architecture, choose the stack, and build the system. Modular, clean, and built to scale.", delay: 80,  img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/compose-5RT5VR4f1Y3GoFmovqTKLTG4UXp3g2.png" },
              { n: "03", title: "Review",    desc: "Test, iterate, and refine. Every feature is reviewed for performance, usability, and reliability before launch.", delay: 140, img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/test-zm8guZwxJHtwWsJ7XO4B0CF7GzlNK8.png" },
              { n: "04", title: "Deploy",  desc: "Ship to production with monitoring, docs, and support. Your software stays healthy with updates and maintenance.", delay: 200, img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/deploy-an8fgHSLzniojkcmRyGGIFQUJF9T5J.png" },
            ].map((step) => (
      ...
      <section id="pricing" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-3xl mx-auto text-center">
          <div className="mb-10 flex flex-col items-center">
            ...
            <RevealText className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
              {"Pay as your software grows."}
            </RevealText>
          </div>
          <p className="text-sm text-black/45 leading-relaxed mb-8 max-w-md mx-auto">
            Every project is different. Whether you need a landing page, a full-stack platform, or an AI workflow, I will scope it and quote it for you directly.
          </p>
          <a
            href="mailto:allankaoga1@gmail.com"
            className="inline-flex items-center gap-2 px-8 py-3.5 bg-[#111] text-white text-sm rounded-xl hover:bg-[#333] transition-colors tracking-widest font-medium"
          >
            EMAIL FOR A QUOTE
          ...
          <p className="mt-4 text-xs text-black/30">allankaoga1@gmail.com</p>
        </div>
      </section>
      ...
      <footer className="py-10 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        ...
        <div className="max-w-6xl mx-auto mt-8 pt-6 border-t border-black/[0.04]">
          <span className="text-xs text-black/20">{"© 2026 all&co. All rights reserved."}</span>
        </div>
      </footer>
    </div>
  )
